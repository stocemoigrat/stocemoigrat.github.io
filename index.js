...
games[games.length] = {
	name: "Scythe",
	imageName: "scythe.jpg", imagePosition: "",
...
games[games.length] = {
	name: "Set",
	imageName: "set.jpg", imagePosition: "background-position-y: center;",
	bggLink: "https://boardgamegeek.com/boardgame/1198/set",
	weight: 1,
	timeToPlay: "15", timeToPlayNum: 15,
	timeToLearn: "5", timeToLearnNum: 5,
	playerCount: [2, 3, 4, 5, 6, 7, 8],
	recPlayerCount: [2, 3, 4, 5, 6, 7, 8],
	bestPlayerCount: [3, 4],
	coop: false,
	type: "party",
...
games[games.length] = {
	...
	imageName: "thecrew.jpg", imagePosition: "",
	bggLink: "https://boardgamegeek.com/boardgame/324856/crew-mission-deep-sea",
	weight: 1.5,
	timeToPlay: "10", timeToPlayNum: 10,
	timeToLearn: "10", timeToLearnNum: 10,
	playerCount: [2, 3, 4, 5],
	recPlayerCount: [2, 3, 4, 5],
	bestPlayerCount: [4],
...
games[games.length] = {
	...
	weight: 2.5,
	timeToPlay: "2h", timeToPlayNum: 120,
	timeToLearn: "25", timeToLearnNum: 25,
...
games[games.length] = {
	name: "Res Arcana",
	imageName: "resarcana.jpg", imagePosition: "",
...
games[games.length] = {
	name: "Sagrada",
	imageName: "sagrada.jpg", imagePosition: "",
	...
	coop: false,
	type: "abstract",
	tags: ["abstract", "open drafting", "pattern building"],
	expansions: [],
	description: "Build the most beautiful stained glass window by drafting dice and placing them on your player board. Each board has some restrictions on which color or value of dice can be placed there. While the game starts off with many possibilities, later rounds will prove to be a real brain burner!"
};
games[games.length] = {
	...
	coop: false,
	type: "hidden roles",
	tags: ["hidden roles", "traitor", "deduction"],
	expansions: [],
	description: "Players take on the roles of investigators attempting to solve a murder case – but there's a twist. The killer is one of the investigators! Each player's role and team are randomly assigned at the start of play and include the unique roles of Forensic Scientist, Witness, Investigator, Murderer, and Accomplice. While the Investigators attempt to deduce the truth, the murderer's team must deceive and mislead.<br><br>The Forensic Scientist has the solution but can only give clues while the investigators (and the murderer) attempt to interpret the evidence. In order to succeed, the investigators must not only deduce the truth from the clues of the Forensic Scientist, they must also see through the misdirection being injected into the equation by the Murderer and Accomplice!"
};
games[games.length] = {
	name: "Similo",
	imageName: "similo.jpg", imagePosition: "",
...
games[games.length] = {
	...
	weight: 4,
	timeToPlay: "3h", timeToPlayNum: 180,
	timeToLearn: "50", timeToLearnNum: 50,
	playerCount: [1, 2, 3, 4],
	recPlayerCount: [2, 3, 4],
	bestPlayerCount: [3],
	coop: false,
